    ...
    groq.chat.completions.create({
        messages: [
          ...
          //{role: "system", content: simulatedChatContent },
            ...
            {role: "system", content: "interface graphique ascii comme template de response avec les `BorderChars`"},
            {role: "system", content: "utlise `figlet` pour les titre par exemple"},
            ...
            {role: "assistant", name:"✨_pi", content: "Intégration des fonctionnalités de base en cours groq to format_type"},
            {role: "system", content: "initialisation du system"},
            {role: "system", content: "initialisation du role:assistant"},
            {role: "system", content: "groq insteface graphique de .response avec les BorderChars"},
            {role: "system", content: `BorderChars` },
            {role: "system", content: BorderChars },
        ...
        const outputFilePath = "chapter1/ascii-dev_" + new Date().toISOString().replace(/[-:TZ]/g, "") + ".md";
